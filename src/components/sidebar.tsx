...
export function Sidebar() {
  ...
  const sections = isInstructor ? instructorSections : studentSections;

  const theme = isInstructor
    ? {
        navActive: "bg-gradient-to-r from-emerald-100 to-green-50 text-emerald-700 dark:from-emerald-900/40 dark:to-green-900/20 dark:text-emerald-300 shadow-sm",
        navIndicator: "from-emerald-500 to-green-500 shadow-emerald-500/50",
        iconActive: "text-emerald-500",
        avatarBg: "from-emerald-500 via-green-500 to-teal-600 shadow-emerald-500/20",
        buttonGradient: "from-emerald-600 to-green-600",
        buttonHover: "hover:from-emerald-700 hover:to-green-700",
        buttonShadow: "shadow-emerald-500/25 hover:shadow-emerald-500/35",
        badge: "bg-emerald-100 text-emerald-700 dark:bg-emerald-900/30 dark:text-emerald-300",
      }
    : {
        navActive: "bg-gradient-to-r from-violet-100 to-indigo-50 text-violet-700 dark:from-violet-900/40 dark:to-indigo-900/20 dark:text-violet-300 shadow-sm",
        navIndicator: "from-violet-500 to-indigo-500 shadow-violet-500/50",
        iconActive: "text-violet-500",
        avatarBg: "from-violet-500 via-indigo-500 to-purple-600 shadow-violet-500/20",
              ...
              <div className="space-y-0.5">
                {section.items.map((item) => {
                  ...
                  return (
                    ...
                    >
                      {active && <div className={`absolute left-0 top-1/2 -translate-y-1/2 w-0.5 h-5 rounded-full bg-gradient-to-b ${theme.navIndicator}`} />}
                      <svg className={`size-4 shrink-0 transition-colors ${active ? theme.iconActive : "text-zinc-400 group-hover:text-zinc-600 dark:group-hover:text-zinc-300"}`} fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="text-sm min-w-0 flex-1">
                  ...
                  <div className="flex items-center gap-1.5 mt-0.5">
                    <span className={`text-[10px] font-medium px-1.5 py-0.5 rounded-full ${theme.badge}`}>
